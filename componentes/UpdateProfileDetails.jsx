            ...
            <View style={styles.inputContainer}>
              {zodiacSigns.map((sign) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.option,
                    zodiac === sign && styles.selected, // Use conditional style
                  ]}
                >
                  <Text
                    style={[
              ...
              {educationLevels.map((level) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.option,
                      isSelected && styles.selected, // Highlight whole button
                    ]}
                  >
                    <Text
                      style={[
              ...
              {childrenOptions.map((option) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.option,
                      isSelected && styles.selected, // highlight full button
                    ]}
                  >
                    <Text
                      style={[
              ...
              {vaccinationOptions.map((option) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.option,
                      isSelected && styles.selected, // Apply selected style to whole button
                    ]}
                  >
                    <Text
                      style={[
